...
import com.example.servlets1.TableViewServlet;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<form action=table-form-servlet method=POST>"
                    + "<input type=text name=rows value=\"\" placeholder=\"строки\"><br>"
                    + "<input type=text name=columns value=\"\" placeholder=\"столбцы\">"
